...
#define EXTRUDERS 2
  ...
  #define MAIN_SCALE_LINE_INTERVAL    1   // 1mm
  #define SUB_SCALE_LINE_INTERVAL     0.9 // 0.9mm
  #define SCALE_MEASUREMENT_ACCURACY  (MAIN_SCALE_LINE_INTERVAL - SUB_SCALE_LINE_INTERVAL)
  #define MAIN_SCALE_LINES            30
  #define SUB_SCALE_LINES             10
  #define MAIN_SUB_SAFE_DISTANCE      0.5 // mm
  #define FIRST_SCALE_LINE_TO_BORDER  3   // mm

  #define SCALE_0_LINE_LENGTH         25  // mm
  #define SCALE_LINE_LENGTH           20  // mm

  #define SCALE_0_LINE_NUMBER         6

  #define X_CALIBRATION_A350_START_POINT_XYZ {140.0, 180.0, 0.2}  //mm
  #define X_CALIBRATION_A250_START_POINT_XYZ {140.0, 180.0, 0.2}
  #define X_CALIBRATION_A150_START_POINT_XYZ {140.0, 180.0, 0.2}

  #define Y_CALIBRATION_A350_START_POINT_XYZ {140.0, 110.0, 0.2}
  ...
  #define X_CALIBRATION_UP_DOWN_LINE_LENGTH     60  // mm
  #define Y_CALIBRATION_LEFT_RIGHT_LINE_LENGTH  60  // mm
  #define Y_CALIBRATION_UP_DOWN_LINE_LENGTH     60  // mm

  #define E_MOVES_FACTOR  0.03326
#endif
