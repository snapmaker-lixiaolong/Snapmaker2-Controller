...
enum ModuleFunctionID {
  ...
  MODULE_FUNC_SET_AUTOFOCUS_LIGHT    ,  // 26
  MODULE_FUNC_REPORT_LASER_GESTURE   ,  // 27
  MODULE_FUNC_SET_LASER_LIMIT_GESTURE,  // 28
  MODULE_FUNC_SET_LASER_POWER        ,  // 29

  MODULE_FUNC_REPORT_SECURITY_STATUS ,  // 30
  MODULE_FUNC_LASER_MOVE_TO_DEST     ,  // 31
  MODULE_FUNC_SET_INITIAL_GESTURE    ,  // 32
...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_TMC_IOCTRL          */  MODULE_FUNC_PRIORITY_LOW,       1},
  {/* MODULE_FUNC_TMC_PUBLISH         */  MODULE_FUNC_PRIORITY_LOW,       1},
  {/* MODULE_FUNC_SET_PURIFIER        */  MODULE_FUNC_PRIORITY_LOW,       1},
  {/* MODULE_FUNC_REPORT_PURIFIER     */  MODULE_FUNC_PRIORITY_LOW,       1},

  {/* MODULE_FUNC_SWITCH_EXTRUDER         */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_SET_AUTOFOCUS_LIGHT     */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_REPORT_LASER_GESTURE    */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_SET_LASER_LIMIT_GESTURE */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_SET_LASER_POWER         */  MODULE_FUNC_PRIORITY_MEDIUM,      1},

  {/* MODULE_FUNC_REPORT_SECURITY_STATUS  */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_LASER_MOVE_TO_DEST      */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
  {/* MODULE_FUNC_SET_INITIAL_GESTURE     */  MODULE_FUNC_PRIORITY_MEDIUM,      1},
