...
enum ModuleFunctionID {
  ...
  MODULE_FUNC_SET_PURIFIER_FUN      ,  // 21
  MODULE_FUNC_SET_PROBE_SENSOR      ,  // 22
  MODULE_FUNC_SET_BLTOUCH           ,  // 23
  MODULE_FUNC_MAX
};
...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_SET_PURIFIER_FUN    */  MODULE_FUNC_PRIORITY_MEDIUM,  1},
  {/* FUNC_SET_PROBE_SENSOR           */  MODULE_FUNC_PRIORITY_MEDIUM,  1},
  {/* MODULE_FUNC_SET_BLTOUCH         */  MODULE_FUNC_PRIORITY_MEDIUM,  1},
